...
import { colorVariants, sizeVariants } from '@/components/logo/variants'
  ...
  return (
    <div
      className={cn(
        colorVariants[color],
        sizeVariants[size],
        hideOnMobile ? 'h-[45px] w-[58px] md:h-[33px] md:w-[110px]' : ''
      )}
    >
      <svg
        ...
        className={hideOnMobile ? 'pointer-events-none h-[45px] md:h-full' : ''}
      >
        <path
